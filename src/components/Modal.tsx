...
export const Modal: React.FC<ModalProps> = ({ isOpen, onClose, title, children }) => {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-in fade-in duration-200">
      <div className="bg-[#1e293b] border border-slate-700 rounded-2xl w-full max-w-xl shadow-2xl animate-in zoom-in-95 duration-200 overflow-hidden relative max-h-[95vh] flex flex-col">
        ...
        <div className="p-6 overflow-y-auto custom-scrollbar bg-[#1e293b] flex-1 min-h-0">
          {children}
        </div>
      </div>
    </div>
