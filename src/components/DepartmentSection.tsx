      ...
      <div className="flex flex-col lg:flex-row gap-4 sm:gap-6 mb-8 relative z-10">
        <div className="flex items-start gap-4 min-w-[240px] lg:flex-shrink-0">
          <div
            ...
            className={`p-3 bg-slate-800 rounded-xl border border-slate-700 shadow-sm text-sky-500 flex-shrink-0 lg:mt-[75px] ${
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-2 sm:gap-3 flex-wrap lg:mt-[75px]">
